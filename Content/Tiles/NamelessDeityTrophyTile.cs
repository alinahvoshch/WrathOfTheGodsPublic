...
{
    private static LazyAsset<Texture2D> tileTexture;

    private static LazyAsset<Texture2D> eyelidTexture;

    private static LazyAsset<Texture2D> scleraTexture;

    private static LazyAsset<Texture2D> pupilTexture;
    ...
    public static readonly SoundStyle BlinkSound = GennedAssets.Sounds.Environment.NamelessDeityTrophyBlink with { PitchVariance = 0.1f };
    ...
    public override void SetStaticDefaults()
    {
        ...
        {
            tileTexture = LazyAsset<Texture2D>.FromPath($"{Texture}Full");
            eyelidTexture = LazyAsset<Texture2D>.FromPath($"{Texture}Eyelid");
            scleraTexture = LazyAsset<Texture2D>.FromPath($"{Texture}Sclera");
            pupilTexture = LazyAsset<Texture2D>.FromPath($"{Texture}Pupil");
        }
    }
