...
public class OblivionChime : ModItem
{
    /// <summary>
    /// The buff ID associated with this chime.
    /// </summary>
    ...
    public override void Load() => BuffID = PetBuffAutoloader.Create(Mod, "NoxusBoss/CuriousHand", "CuriousHandBuff");
    ...
    public override void SetDefaults()
    {
        ...
        Item.shoot = ModContent.ProjectileType<CuriousHand>();
