...
public class LargeMistParticle : Particle
{
    ...
    {
        Rectangle frame = Texture.Frame.Subdivide(1, FrameCount, 0, (int)(LifetimeRatio * FrameCount));
        spriteBatch.Draw(Texture, Position - Main.screenPosition, frame, DrawColor * Opacity, Rotation, null, Scale, SpriteEffects.None);
    }
}
