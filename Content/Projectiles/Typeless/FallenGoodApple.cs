...
public class FallenGoodApple : ModProjectile
{
    ...
    public override string Texture => GetAssetPath("Content/Items", ModContent.GetInstance<GoodApple>().Name);
    ...
    public override void AI()
    {
        ...
        if (closestPlayer.Hitbox.Intersects(Projectile.Hitbox) && Abs(Projectile.velocity.Y - 0.3f) <= 0.0001f)
        {
            Projectile.Kill();
            closestPlayer.QuickSpawnItem(new EntitySource_WorldEvent(), ModContent.ItemType<GoodApple>());
        }
