...
public class WindStreakVisual : ModProjectile, IPixelatedPrimitiveRenderer
{
    ...
    public override void AI()
    {
        ...
        {
            Projectile.velocity = Vector2.Lerp(Projectile.velocity, loopVelocity, 0.2f);
    ...
    public void RenderPixelatedPrimitives(SpriteBatch spriteBatch)
    {
        ...
        PrimitiveSettings settings = new PrimitiveSettings(WindWidthFunction, WindColorFunction, _ => Projectile.Size * 0.5f, Pixelate: true, Shader: shader);
