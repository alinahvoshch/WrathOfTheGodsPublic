...
public class VergilScreenSlice : ModProjectile, IProjOwnedByBoss<NamelessDeityBoss>
{
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        if (Time <= TelegraphTime)
        {
            ...
            Main.spriteBatch.DrawBloomLine(Projectile.Center, Projectile.Center + Projectile.velocity * localLineLength, (Color.IndianRed with { A = 0 }) * opacityFactor, Projectile.width * scaleFactor * 3f);
            Main.spriteBatch.DrawBloomLine(Projectile.Center, Projectile.Center + Projectile.velocity * localLineLength, (Color.Wheat with { A = 0 }) * opacityFactor, Projectile.width * scaleFactor * 1.6f);
        }
        return false;
    }
