...
public class ArcingStarburst : ModProjectile, IPixelatedPrimitiveRenderer, IProjOwnedByBoss<NamelessDeityBoss>
{
    /// <summary>
    /// How long this starburst has existed for, in frames.
    /// </summary>
    public ref float Time => ref Projectile.ai[0];

    /// <summary>
    /// A factor which dictates how fast this starburst may fly.
    /// </summary>
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        // Draw the star.
        Texture2D texture = GennedAssets.Textures.Projectiles.ArcingStarburst.Value;
