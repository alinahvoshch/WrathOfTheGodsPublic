...
public class Starburst : ModProjectile, IPixelatedPrimitiveRenderer, IProjOwnedByBoss<NamelessDeityBoss>
{
    ...
    public override void SetDefaults()
    {
        ...
        if (namelessModNPC.CurrentState == NamelessDeityBoss.NamelessAIType.SunBlenderBeams)
        ...
        if (namelessModNPC.CurrentState == NamelessDeityBoss.NamelessAIType.ClockConstellation)
    ...
    public override void AI()
    {
        ...
        if (!Redirect)
        {
            Projectile.Opacity = InverseLerp(0f, 12f, Projectile.timeLeft);
    ...
    public static void DrawStarburstBloomFlare(Projectile projectile, float opacityFactor = 1f)
    {
        ...
        else if (namelessModNPC.CurrentState == NamelessDeityBoss.NamelessAIType.ClockConstellation)
            backglowOpacityFactor *= 0.125f;
        else if (namelessModNPC.CurrentState == NamelessDeityBoss.NamelessAIType.SunBlenderBeams)
        {
            baseColor1 = Color.Red;
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        float scaleFactor = namelessModNPC.TeleportVisualsAdjustedScale.Length() * 0.707f;
        float againstNamelessInterpolant = InverseLerp(600f, 450f, Projectile.Distance(nameless.Center) / scaleFactor) * nameless.Opacity;
    ...
    public void RenderPixelatedPrimitives(SpriteBatch spriteBatch)
    {
        ...
        shader.SetTexture(GennedAssets.Textures.TrailStreaks.StreakBloomLine, 1, SamplerState.LinearWrap);
