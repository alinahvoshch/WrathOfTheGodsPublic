...
using static NoxusBoss.Core.Graphics.SpecificEffectManagers.EmptinessSprayPlayerDeletionSystem;
...
public class NamelessDeityTipsOverrideSystem : ModSystem
{
    ...
    public static readonly Regex PercentageExtractor = new Regex(@"([0-9]+%)", RegexOptions.Compiled);

    public static string SprayDeletionTipsText => Language.GetTextValue("Mods.NoxusBoss.Dialog.NamelessDeityEmptinessSprayerTip");
