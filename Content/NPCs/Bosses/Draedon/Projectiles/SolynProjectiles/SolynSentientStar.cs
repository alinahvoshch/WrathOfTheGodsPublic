...
public class SolynSentientStar : ModProjectile, IPixelatedPrimitiveRenderer, IProjOwnedByBoss<BattleSolyn>
{
    /// <summary>
    ...
    {
        if (!NPC.AnyNPCs(ModContent.NPCType<BattleSolyn>()))
        {
            Projectile.Kill();
            return;
        }
        ...
        if (Main.rand.NextBool(3))
        {
            ...
            float starScale = Lerp(0.2f, 0.4f, starScaleInterpolant) * Projectile.scale;
