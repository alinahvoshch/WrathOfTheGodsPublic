...
public class LoopedSoundManager : ModSystem
{
    ...
    {
        LoopedSoundInstance sound = new LoopedSoundInstance(loopingSound, automaticTerminationCondition ?? (() => false));
    ...
    {
        LoopedSoundInstance sound = new LoopedSoundInstance(startingSound, loopingSound, automaticTerminationCondition ?? (() => false));
        loopedSounds.Add(sound);
