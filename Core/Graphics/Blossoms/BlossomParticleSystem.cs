...
public class BlossomParticleSystem : FastParticleSystem
{
    public BlossomParticleSystem(int maxParticles, Action renderPreparations, ParticleUpdateAction? extraUpdates = null) :
    ...
    protected override void PopulateVertexBufferIndex(VertexPosition2DColorTexture[] vertices, int particleIndex)
    {
        ...
        MatrixSIMD particleRotationMatrix = MatrixSIMD.CreateRotationX(particle.Rotation * 0.3f) *
