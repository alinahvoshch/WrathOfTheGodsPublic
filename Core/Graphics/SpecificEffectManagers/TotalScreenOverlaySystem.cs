...
public class TotalScreenOverlaySystem : ModSystem
{
    ...
    public override void OnWorldLoad() => OverlayInterpolant = 0f;

    public override void OnWorldUnload() => OverlayInterpolant = 0f;

    public override void PreUpdateEntities()
    {
        OverlayInterpolant = Clamp(OverlayInterpolant - 0.04f, 0f, 5f);
    ...
    private void DrawWhite(GameTime obj)
    {
        ...
        Main.spriteBatch.Draw(WhitePixel, Main.ScreenSize.ToVector2() * 0.5f, null, OverlayColor * Saturate(OverlayInterpolant), 0f, WhitePixel.Size() * 0.5f, pixelScale, 0, 0f);
