...
namespace NoxusBoss.Core.BaseEntities;
...
public abstract class BaseTelegraphedPrimitiveLaserbeam : BasePrimitiveLaserbeam
{
    ...
    public void DrawTelegraphOrLaser(bool pixelate)
    {
        ...
        if (Time <= TelegraphTime)
        {
            ...
            PrimitiveSettings settings = new PrimitiveSettings(TelegraphWidthFunction, TelegraphColorFunction, Shader: TelegraphShader, Pixelate: pixelate);
