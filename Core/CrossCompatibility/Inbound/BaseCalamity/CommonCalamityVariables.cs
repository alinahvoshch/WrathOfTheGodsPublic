...
public static partial class CommonCalamityVariables
{
    ...
    public static bool TryGetFromModCall<T>(out T result, params string[] modCallInfo)
    {
        ...
        // Yes, this can be null in theory. But unless a user abuses the TryGetX pattern and ignores the bool result it does not matter.
        result = default!;
        ...
        if (Calamity is not null)
        {
            ...
            object callResult = Calamity.Call(modCallInfo);
    ...
    public static void TrySetFromModCall(object value, params string[] modCallInfo)
    {
        ...
        Calamity.Call(modCallInfo, value);
    }
}
